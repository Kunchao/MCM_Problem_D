...
class people:
    def __init__(self,arrive_time,package):
        self.wait_time=0
...
class simulation:
    ...
    def generate_people(self):
            if self.time_clock >= self.next_tsa_people_time and self.people_num<self.people_limit:
                ...
                self.people_line[0][3].put(people(self.time_clock,random.random()))
                self.people_num+=1
    ...
    def IDcheck(self,index):
        while 1:
            ...
            if people:
                print 'IDcheck begin'
                IDcheck_time=self.tsa_IDcheck_time*people.package
    ...
    def getbags(self,index):
        while 1:
            ...
            if people:
                ...
                getbags_time=random.uniform(self.getbags_time - wave_num,self.getbags_time + wave_num)*people.package
    ...
    def manage(self):
        #==========================================================
        #     set 1 to 0 you can open other circumstance
        while 1:
            if not self.people_line[0][3].empty():
                people=self.people_line[0][3].get()
                if people.package>0.66:
                    people.package=2
                    self.people_line[0][0].append(people)
                else:
                    people.package=1
                    self.people_line[0][1].append(people)

            if not self.people_line[1][3].empty():
                people=self.people_line[1][3].get()
                if people.package>1:
                    self.people_line[1][0].append(people)
                else:
                    self.people_line[1][1].append(people)
        while 1:
            if not self.people_line[0][3].empty():
                people=self.people_line[0][3].get()
                if people.package>0.66:
                    ...
                    people.package=1
                if len(self.people_line[0][0]) < len(self.people_line[0][1]):
                    self.people_line[0][0].append(people)
                else:
                    self.people_line[0][1].append(people)
            ...
            if not self.people_line[1][3].empty():
                people=self.people_line[1][3].get()
                if len(self.people_line[1][0]) < len(self.people_line[1][1]):
                    self.people_line[1][0].append(people)
                else:
                    self.people_line[1][1].append(people)  
